			...
			<div class="container">
				<h2 class="page-title">
					<?php
						...
						elseif ( is_month() ) :
							printf( __( 'Month: %s', 'bootstrap2wordpress' ), '<span style="font-size: 28px; color: #91cc02;">' . get_the_date( _x( 'F Y', 'monthly archives date format', 'bootstrap2wordpress' ) ) . '</span>' );
